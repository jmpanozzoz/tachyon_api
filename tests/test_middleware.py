...
async def test_class_middleware():
    """
    Verify that a class-based middleware can intercept and modify the response
    when added with add_middleware.
    """
...
async def test_decorator_middleware():
    """
    Verify that a middleware defined with the @app.middleware decorator can
    intercept and modify the response generated by an endpoint.
    """
    # Create a base Tachyon application
    app = Tachyon()
...
async def test_multiple_middlewares():
    """
    Verify that multiple middlewares can be applied using both approaches
    (class and decorator) and all can modify the response.
    """
    # Create a base Tachyon application
    app = Tachyon()
